        ...
        <form onSubmit={handleSubmit}>
          <div>
            <label className="label p-2">
              <span className="text-base label-text text-slate-600 font-semibold">Full Name</span>
            </label>
          ...
          <div>
            <label className="label p-2">
              <span className="text-base label-text text-slate-600 font-semibold">Username</span>
            </label>
            <label className="input input-bordered flex items-center gap-2">
          ...
          <div>
            <label className="label">
              <span className="text-base label-text text-slate-600 font-semibold">Password</span>
            </label>
            <label className="input input-bordered flex items-center gap-2">
          ...
          <div>
            <label className="label">
              <span className="text-base label-text text-slate-600 font-semibold">Confirm Password</span>
            </label>
            <label className="input input-bordered flex items-center gap-2">
